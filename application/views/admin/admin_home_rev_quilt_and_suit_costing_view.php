...
<section class="content-header">
    ...
    ?>
    <a class="btn btn-default" href="<?php echo base_url("quiltandsuit/quilt_and_suit_all"); ?>">All Quilt & Suit</a>
    <h1>Revisioned Quilt and Suit Costing</h1>
</section>
                ...
                <div class="part1 row">
                    ...
                    <div class="col-md-2 ">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control quilt-and-suit-costing" name="order_date" id="order_date" placeholder="Date" value="<?php echo $quilt_and_suit_order_date ?>" required>
                        </div>
                    </div>
                    ...
                    <div class="col-md-4 col-md-offset-1">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control quilt-and-suit-costing" name="order_company" id="order_company" placeholder="Order Company" value="<?php echo $quilt_and_suit_company_name ?>"  required>
                        </div>
                    </div>
                    ...
                    <div class="col-md-2">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control quilt-and-suit-costing" name="order_item_name" id="order_item_name"  placeholder="Order Item Name"  value="<?php echo $quilt_and_suit_item_name ?>" required>
                        </div>
                    </div>
                    <div class="col-md-2">
                        <div class="form-group">
                            <label for="order_ref_no">Reference No.:</label>
                            <input type="text" class="form-control quilt-and-suit-costing" name="order_ref_no" id="order_ref_no" placeholder="Order Reference No."  value="<?php echo $quilt_and_suit_ref_name ?>" required>
                        </div>
                    </div>
            ...
            <section class="col-md-8">
                ...
                <div class="row part4">
                    ...
                    <div class="col-md-6">
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group role-width">
                                    <input type="text" class="form-control quilt-and-suit-costing" id="body_material_1_roll_1" name="body_material_1_roll_1" placeholder="Roll Width" value="<?php echo $quilt_and_suit_body_material_1_roll_width ?>" required>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group role-width">
                                    <input type="text" class="form-control quilt-and-suit-costing" id="body_material_2_roll_2" name="body_material_2_roll_2"  placeholder="Roll Width" value="<?php echo $quilt_and_suit_body_material_2_roll_width ?>" required>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group role-width">
                                    <input type="text" class="form-control quilt-and-suit-costing" id="body_material_3_roll_3" name="body_material_3_roll_3" placeholder="Roll Width" value="<?php echo $quilt_and_suit_body_material_3_roll_width ?>" required>
                                </div>
                            </div>
                        </div>
                ...
                <article class="row part3">
                    ...
                    <table class="table table-bordered">
                        ...
                        <tr class="success">
                            <td>GSM PPNW:</td>
                            <td><input type="text" class="form-control quilt-and-suit-costing" id="body_material_1_cost" name="body_material_1_cost" value="<?php echo $quilt_and_suit_body_material_1_cost?>" required></td>
                        ...
                        <tr class="success">
                            ...
                            <td><input type="text" class="form-control quilt-and-suit-costing" id="body_material_2_cost" name="body_material_2_cost" value="<?php echo $quilt_and_suit_body_material_2_cost?>" required></td>
                        ...
                        <tr class="success">
                            ...
                            <td><input type="text" class="form-control quilt-and-suit-costing" id="body_material_3_cost" name="body_material_3_cost" value="<?php echo $quilt_and_suit_body_material_3_cost?>" required></td>
                    ...
                    <table class="table table-bordered">
                        ...
                        <tr class="danger">
                            <td >Webbing</td>
                            <td><input type="text" class="form-control quilt-and-suit-costing" id="webbing_cost" name="two_inch_webbing_cost" value="<?php echo $quilt_and_suit_trims_yard_webbing_item_cost ?>" ></td>
                            <td><input type="text" class="form-control quilt-and-suit-costing" id="webbing_consumption" name="two_inch_webbing_consumption" value="<?php echo $quilt_and_suit_trims_yard_webbing_item_consumption ?>" ></td>
                            <td><input type="text" class="form-control quilt-and-suit-costing" id="webbing_consumption_rate" name="two_inch_webbing_consumption_rate" readonly="readonly" value="<?php echo $quilt_and_suit_trims_yard_webbing_item_rate ?>"></td>
                            <td><input type="text" class="form-control quilt-and-suit-costing" id="webbing_consumption_cost" name="two_inch_webbing_consumption_cost" readonly="readonly" value="<?php echo $quilt_and_suit_trims_yard_webbing_item_total_cost ?>"></td>
                        </tr>

                        <tr class="danger">
                            <td>Velcro</td>
                            <td><input type="text" class="form-control quilt-and-suit-costing" id="velcro_cost" name="velcro_cost" value="<?php echo $quilt_and_suit_trims_yard_velcro_item_cost ?>"></td>
                            <td><input type="text" class="form-control quilt-and-suit-costing" id="velcro_consumption" name="velcro_consumption" value="<?php echo $quilt_and_suit_trims_yard_velcro_item_consumption ?>"></td>
                            <td><input type="text" class="form-control quilt-and-suit-costing" id="velcro_consumption_rate" name="velcro_consumption_rate" value="<?php echo $quilt_and_suit_trims_yard_velcro_item_rate ?>" readonly="readonly"></td>
                            <td><input type="text" class="form-control quilt-and-suit-costing" id="velcro_consumption_cost" name="velcro_consumption_cost" value="<?php echo $quilt_and_suit_trims_yard_velcro_item_total_cost ?>" readonly="readonly"></td>
                        </tr>
                        ...
                        <tr class="danger">
                            <td><input type="text" class="form-control quilt-and-suit-costing" id="extra_trim_yard_extra_1" name="extra_trim_yard_extra_1_name" value="<?php echo $extra_trim_yard_extra_1_name ?>" placeholder="Extra 1"></td>
                            <td><input type="text" class="form-control quilt-and-suit-costing" id="extra_trim_yard_1_cost" name="extra_trim_yard_1_cost" value="<?php echo $quilt_and_suit_trims_yard_extra_1_item_cost ?>"></td>
                            <td><input type="text" class="form-control quilt-and-suit-costing" id="extra_trim_yard_1_consumption" name="extra_trim_yard_1_consumption" value="<?php echo $quilt_and_suit_trims_yard_extra_1_item_consumption ?>"></td>
                            <td><input type="text" class="form-control quilt-and-suit-costing" id="extra_trim_yard_1_consumption_rate" name="extra_trim_yard_1_consumption_rate" value="<?php echo $quilt_and_suit_trims_yard_extra_1_item_rate ?>" readonly="readonly"></td>
                            <td><input type="text" class="form-control quilt-and-suit-costing" id="extra_trim_yard_1_consumption_cost" name="extra_trim_yard_1_consumption_cost" value="<?php echo $quilt_and_suit_trims_yard_extra_1_item_total_cost ?>" readonly="readonly"></td>
                        </tr>

                        <tr class="danger">
                            <td><input type="text" class="form-control quilt-and-suit-costing" id="extra_trim_yard_extra_2" name="extra_trim_yard_extra_2_name" value="<?php echo $extra_trim_yard_extra_2_name ?>" placeholder="Extra 2"></td>
                            <td><input type="text" class="form-control quilt-and-suit-costing" id="extra_trim_yard_2_cost" name="extra_trim_yard_2_cost" value="<?php echo $quilt_and_suit_trims_yard_extra_2_item_cost ?>" ></td>
                            <td><input type="text" class="form-control quilt-and-suit-costing" id="extra_trim_yard_2_consumption" name="extra_trim_yard_2_consumption" value="<?php echo $quilt_and_suit_trims_yard_extra_2_item_consumption ?>"></td>
                            <td><input type="text" class="form-control quilt-and-suit-costing" id="extra_trim_yard_2_consumption_rate" name="extra_trim_yard_2_consumption_rate" value="<?php echo $quilt_and_suit_trims_yard_extra_2_item_rate ?>" readonly="readonly"></td>
                            <td><input type="text" class="form-control quilt-and-suit-costing" id="extra_trim_yard_2_consumption_cost" name="extra_trim_yard_2_consumption_cost" value="<?php echo $quilt_and_suit_trims_yard_extra_2_item_total_cost ?>" readonly="readonly"></td>
                        </tr>

                        <tr class="danger">
                            <td><input type="text" class="form-control quilt-and-suit-costing" id="extra_trim_yard_extra_3" name="extra_trim_yard_extra_3_name" value="<?php echo $extra_trim_yard_extra_3_name ?>" placeholder="Extra 3"></td>
                            <td><input type="text" class="form-control quilt-and-suit-costing" id="extra_trim_yard_3_cost" name="extra_trim_yard_3_cost" value="<?php echo $quilt_and_suit_trims_yard_extra_3_item_cost ?>"></td>
                            <td><input type="text" class="form-control quilt-and-suit-costing" id="extra_trim_yard_3_consumption" name="extra_trim_yard_3_consumption" value="<?php echo $quilt_and_suit_trims_yard_extra_3_item_consumption ?>"></td>
                            <td><input type="text" class="form-control quilt-and-suit-costing" id="extra_trim_yard_3_consumption_rate" name="extra_trim_yard_3_consumption_rate" value="<?php echo $quilt_and_suit_trims_yard_extra_3_item_rate ?>" readonly="readonly"></td>
                            <td><input type="text" class="form-control quilt-and-suit-costing" id="extra_trim_yard_3_consumption_cost" name="extra_trim_yard_3_consumption_cost" value="<?php echo $quilt_and_suit_trims_yard_extra_3_item_total_cost ?>" readonly="readonly"></td>
                        </tr>
                        </tbody>
                    ...
                    <table class="table table-bordered">
                        ...
                        <tr class="info">
                            <td>Puller</td>
                            <td><input type="text" class="form-control quilt-and-suit-costing" id="puller_cost" name="puller_cost" value="<?php echo $quilt_and_suit_trims_piece_puller_item_cost ?>"></td>
                            <td><input type="text" class="form-control quilt-and-suit-costing" id="puller_consumption" name="puller_consumption" value="<?php echo $quilt_and_suit_trims_piece_puller_item_consumption ?>"></td>
                            <td><input type="text" class="form-control quilt-and-suit-costing" id="puller_consumption_rate" name="puller_consumption_rate" value="<?php echo $quilt_and_suit_trims_piece_puller_item_rate ?>" readonly="readonly"></td>
                            <td><input type="text" class="form-control quilt-and-suit-costing" id="puller_consumption_cost" name="puller_consumption_cost" value="<?php echo $quilt_and_suit_trims_piece_puller_item_total_cost ?>" readonly="readonly"></td>
                        </tr>

                        <tr class="info">
                            <td>Print</td>
                            <td><input type="text" class="form-control quilt-and-suit-costing" id="print_cost" name="print_cost" value="<?php echo $quilt_and_suit_trims_piece_print_item_cost ?>"></td>
                            <td><input type="text" class="form-control quilt-and-suit-costing" id="print_consumption" name="print_consumption" value="<?php echo $quilt_and_suit_trims_piece_print_item_consumption ?>"></td>
                            <td><input type="text" class="form-control quilt-and-suit-costing" id="print_consumption_rate" name="print_consumption_rate" value="<?php echo $quilt_and_suit_trims_piece_print_item_rate ?>" readonly="readonly"></td>
                            <td><input type="text" class="form-control quilt-and-suit-costing" id="print_consumption_cost" name="print_consumption_cost" value="<?php echo $quilt_and_suit_trims_piece_print_item_total_cost ?>" readonly="readonly"></td>
                        </tr>
                        <tr class="info">
                            <td>Eyelet</td>
                        ...
                        <tr class="info">
                            <td>Buckle</td>
                            <td><input type="text" class="form-control quilt-and-suit-costing" id="buckle_cost" name="buckle_cost" value="<?php echo $quilt_and_suit_trims_piece_buckle_item_cost ?>"></td>
                            <td><input type="text" class="form-control quilt-and-suit-costing" id="buckle_consumption" name="buckle_consumption" value="<?php echo $quilt_and_suit_trims_piece_buckle_item_consumption ?>"></td>
                            <td><input type="text" class="form-control quilt-and-suit-costing" id="buckle_consumption_rate" name="buckle_consumption_rate" value="<?php echo $quilt_and_suit_trims_piece_buckle_item_rate ?>" readonly="readonly"></td>
                            <td><input type="text" class="form-control quilt-and-suit-costing" id="buckle_consumption_cost" name="buckle_consumption_cost" value="<?php echo $quilt_and_suit_trims_piece_buckle_item_total_cost ?>" readonly="readonly"></td>
                        </tr>

                        <tr class="info">
                            <td>Magnetic Button</td>
                            <td><input type="text" class="form-control quilt-and-suit-costing" id="magnetic_button_cost" name="magnetic_button_cost" value="<?php echo $quilt_and_suit_trims_piece_magnetic_button_item_cost ?>"></td>
                            <td><input type="text" class="form-control quilt-and-suit-costing" id="magnetic_button_consumption" name="magnetic_button_consumption" value="<?php echo $quilt_and_suit_trims_piece_magnetic_button_item_consumption ?>"></td>
                            <td><input type="text" class="form-control quilt-and-suit-costing" id="magnetic_button_consumption_rate" name="magnetic_button_consumption_rate" value="<?php echo $quilt_and_suit_trims_piece_magnetic_button_item_rate ?>" readonly="readonly"></td>
                            <td><input type="text" class="form-control quilt-and-suit-costing" id="magnetic_button_consumption_cost" name="magnetic_button_consumption_cost" value="<?php echo $quilt_and_suit_trims_piece_magnetic_button_item_total_cost ?>" readonly="readonly"></td>
                        </tr>

                        <tr class="info">
                            <td>Snap Button</td>
                            <td><input type="text" class="form-control quilt-and-suit-costing" id="snap_button_cost" name="snap_button_cost" value="<?php echo $quilt_and_suit_trims_piece_snap_button_item_cost ?>"></td>
                            <td><input type="text" class="form-control quilt-and-suit-costing" id="snap_button_consumption" name="snap_button_consumption" value="<?php echo $quilt_and_suit_trims_piece_snap_button_item_consumption ?>"></td>
                            <td><input type="text" class="form-control quilt-and-suit-costing" id="snap_button_consumption_rate" name="snap_button_consumption_rate" value="<?php echo $quilt_and_suit_trims_piece_snap_button_item_rate ?>" readonly="readonly"></td>
                            <td><input type="text" class="form-control quilt-and-suit-costing" id="snap_button_consumption_cost" name="snap_button_consumption_cost" value="<?php echo $quilt_and_suit_trims_piece_snap_button_item_total_cost ?>" readonly="readonly"></td>
                        </tr>

                        <tr class="info">
                            <td>Bottom Base</td>
                            <td><input type="text" class="form-control quilt-and-suit-costing" id="bottom_base_cost" name="bottom_base_cost" value="<?php echo $quilt_and_suit_trims_piece_bottom_base_item_cost ?>"></td>
                            <td><input type="text" class="form-control quilt-and-suit-costing" id="bottom_base_consumption" name="bottom_base_consumption" value="<?php echo $quilt_and_suit_trims_piece_bottom_base_item_consumption ?>"></td>
                            <td><input type="text" class="form-control quilt-and-suit-costing" id="bottom_base_consumption_rate" name="bottom_base_consumption_rate" value="<?php echo $quilt_and_suit_trims_piece_bottom_base_item_rate ?>" readonly="readonly"></td>
                            <td><input type="text" class="form-control quilt-and-suit-costing" id="bottom_base_consumption_cost" name="bottom_base_consumption_cost" value="<?php echo $quilt_and_suit_trims_piece_bottom_base_item_total_cost ?>" readonly="readonly"></td>
                        </tr>

                        <tr class="info">
                            <td>Thread</td>
                            <td><input type="text" class="form-control quilt-and-suit-costing" id="thread_cost" name="thread_cost"  value="<?php echo $quilt_and_suit_trims_piece_thread_item_cost ?>"></td>
                            <td><input type="text" class="form-control quilt-and-suit-costing" id="thread_consumption" name="thread_consumption"  value="<?php echo $quilt_and_suit_trims_piece_thread_item_consumption ?>"></td>
                            <td><input type="text" class="form-control quilt-and-suit-costing" id="thread_consumption_rate" name="thread_consumption_rate" value="<?php echo $quilt_and_suit_trims_piece_thread_item_rate ?>" readonly="readonly"></td>
                            <td><input type="text" class="form-control quilt-and-suit-costing" id="thread_consumption_cost" name="thread_consumption_cost"  value="<?php echo $quilt_and_suit_trims_piece_thread_item_total_cost ?>" readonly="readonly"></td>
                        </tr>

                        <tr class="info">
                            <td>Tag</td>
                            <td><input type="text" class="form-control quilt-and-suit-costing" id="tag_cost" name="tag_cost"  value="<?php echo $quilt_and_suit_trims_piece_tag_item_cost ?>"></td>
                            <td><input type="text" class="form-control quilt-and-suit-costing" id="tag_consumption" name="tag_consumption"  value="<?php echo $quilt_and_suit_trims_piece_tag_item_consumption ?>"></td>
                            <td><input type="text" class="form-control quilt-and-suit-costing" id="tag_consumption_rate" name="tag_consumption_rate"  value="<?php echo $quilt_and_suit_trims_piece_tag_item_rate ?>" readonly="readonly"></td>
                            <td><input type="text" class="form-control quilt-and-suit-costing" id="tag_consumption_cost" name="tag_consumption_cost"  value="<?php echo $quilt_and_suit_trims_piece_tag_item_total_cost ?>" readonly="readonly"></td>
                        </tr>

                        <tr class="info">
                            <td>Label</td>
                            <td><input type="text" class="form-control quilt-and-suit-costing" id="label_cost" name="label_cost"  value="<?php echo $quilt_and_suit_trims_piece_label_item_cost ?>"></td>
                            <td><input type="text" class="form-control quilt-and-suit-costing" id="label_consumption" name="label_consumption" value="<?php echo $quilt_and_suit_trims_piece_label_item_consumption ?>" ></td>
                            <td><input type="text" class="form-control quilt-and-suit-costing" id="label_consumption_rate" name="label_consumption_rate" value="<?php echo $quilt_and_suit_trims_piece_label_item_rate ?>" readonly="readonly"></td>
                            <td><input type="text" class="form-control quilt-and-suit-costing" id="label_consumption_cost" name="label_consumption_cost" value="<?php echo $quilt_and_suit_trims_piece_label_item_total_cost ?>" readonly="readonly"></td>
                        </tr>

                        <tr class="info">
                            <td>Packing</td>
                            <td><input type="text" class="form-control quilt-and-suit-costing" id="packing_cost" name="packing_cost" value="<?php echo $quilt_and_suit_trims_piece_packing_item_cost ?>" ></td>
                            <td><input type="text" class="form-control quilt-and-suit-costing" id="packing_consumption" name="packing_consumption" value="<?php echo $quilt_and_suit_trims_piece_packing_item_consumption ?>" ></td>
                            <td><input type="text" class="form-control quilt-and-suit-costing" id="packing_consumption_rate" name="packing_consumption_rate" value="<?php echo $quilt_and_suit_trims_piece_packing_item_rate ?>"  readonly="readonly"></td>
                            <td><input type="text" class="form-control quilt-and-suit-costing" id="packing_consumption_cost" name="packing_consumption_cost" value="<?php echo $quilt_and_suit_trims_piece_packing_item_total_cost ?>" readonly="readonly"></td>
                        </tr>

                        <tr class="info">
                            <td><input type="text" class="form-control quilt-and-suit-costing" id="extra_1_piece_name" placeholder="Extra 1" name="extra_1_piece_name"  value="<?php echo $quilt_and_suit_trims_piece_extra_1_name ?>"></td>
                            <td><input type="text" class="form-control quilt-and-suit-costing" id="extra_1_piece_cost" name="extra_1_piece_cost" value="<?php echo $quilt_and_suit_trims_piece_extra_1_item_cost ?>" ></td>
                            <td><input type="text" class="form-control quilt-and-suit-costing" id="extra_1_piece_consumption" name="extra_1_piece_consumption" value="<?php echo $quilt_and_suit_trims_piece_extra_1_item_consumption ?>" ></td>
                            <td><input type="text" class="form-control quilt-and-suit-costing" id="extra_1_piece_consumption_rate" name="extra_1_piece_consumption_rate" value="<?php echo $quilt_and_suit_trims_piece_extra_1_item_rate ?>" readonly="readonly"></td>
                            <td><input type="text" class="form-control quilt-and-suit-costing" id="extra_1_piece_consumption_cost" name="extra_1_piece_consumption_cost" value="<?php echo $quilt_and_suit_trims_piece_extra_1_item_total_cost ?>" readonly="readonly"></td>
                        </tr>

                        <tr class="info">
                            <td><input type="text" class="form-control quilt-and-suit-costing" id="extra_2_piece_name" placeholder="Extra 2" name="extra_2_piece_name" value="<?php echo $quilt_and_suit_trims_piece_extra_2_name ?>" ></td>
                            <td><input type="text" class="form-control quilt-and-suit-costing" id="extra_2_piece_cost" name="extra_2_piece_cost" value="<?php echo $quilt_and_suit_trims_piece_extra_2_item_cost ?>" ></td>
                            <td><input type="text" class="form-control quilt-and-suit-costing" id="extra_2_piece_consumption" name="extra_2_piece_consumption" value="<?php echo $quilt_and_suit_trims_piece_extra_2_item_consumption ?>" ></td>
                            <td><input type="text" class="form-control quilt-and-suit-costing" id="extra_2_piece_consumption_rate" name="extra_2_piece_consumption_rate" value="<?php echo $quilt_and_suit_trims_piece_extra_2_item_rate ?>" readonly="readonly"></td>
                            <td><input type="text" class="form-control quilt-and-suit-costing" id="extra_2_piece_consumption_cost" name="extra_2_piece_consumption_cost" value="<?php echo $quilt_and_suit_trims_piece_extra_2_item_total_cost ?>" readonly="readonly"></td>
                        </tr>

                        <tr class="info">
                            <td><input type="text" class="form-control quilt-and-suit-costing" id="extra_3_piece_name" placeholder="Extra 2" name="extra_2_piece_name" value="<?php echo $quilt_and_suit_trims_piece_extra_3_name ?>" ></td>
                            <td><input type="text" class="form-control quilt-and-suit-costing" id="extra_3_piece_cost" name="extra_2_piece_cost" value="<?php echo $quilt_and_suit_trims_piece_extra_3_item_cost ?>" ></td>
                            <td><input type="text" class="form-control quilt-and-suit-costing" id="extra_3_piece_consumption" name="extra_2_piece_consumption" value="<?php echo $quilt_and_suit_trims_piece_extra_3_item_consumption ?>" ></td>
                            <td><input type="text" class="form-control quilt-and-suit-costing" id="extra_3_piece_consumption_rate" name="extra_2_piece_consumption_rate" value="<?php echo $quilt_and_suit_trims_piece_extra_3_item_rate ?>" readonly="readonly"></td>
                            <td><input type="text" class="form-control quilt-and-suit-costing" id="extra_3_piece_consumption_cost" name="extra_2_piece_consumption_cost" value="<?php echo $quilt_and_suit_trims_piece_extra_3_item_total_cost ?>" readonly="readonly"></td>
                        </tr>
                    ...
                    <div class="part3">
                        ...
                        <table style="width:100%" class="table table-bordered woven-table">
                            ...
                            <tr>
                                ...
                                <td><input type="text" class="form-control quilt-and-suit-costing" id="body_material_1_front_length_total" name="body_material_1_front_length_total" value="<?php echo $body_material_1_front_length_total ?>" readonly="readonly"></td>
                                ...
                                <td><input type="text" class="form-control quilt-and-suit-costing" id="body_material_2_front_length_total" name="body_material_2_front_length_total" value="<?php echo $body_material_2_front_length_total ?>" readonly="readonly"></td>
                                ...
                                <td><input type="text" class="form-control quilt-and-suit-costing" id="body_material_3_front_length_total" name="body_material_3_front_length_total" value="<?php echo $body_material_3_front_length_total ?>" readonly="readonly"></td>
                            </tr>
                            <tr>
                                <td>Width</td>
                                ...
                                <td><input type="text" class="form-control quilt-and-suit-costing" id="body_material_1_front_width_total" name="body_material_1_front_width_total" value="<?php echo $body_material_1_front_width_total ?>" readonly="readonly"></td>
                                ...
                                <td><input type="text" class="form-control quilt-and-suit-costing" id="body_material_3_front_width_total" name="body_material_3_front_width_total" value="<?php echo $body_material_3_front_width_total ?>" readonly="readonly"></td>
                            </tr>
                            <tr>
                                ...
                                <td><input type="text" class="form-control quilt-and-suit-costing" id="body_material_1_back_length_total" name="body_material_1_back_length_total" value="<?php echo $body_material_1_back_length_total ?>" readonly="readonly"></td>
                                ...
                                <td><input type="text" class="form-control quilt-and-suit-costing" id="body_material_2_back_length_total" name="body_material_2_back_length_total" value="<?php echo $body_material_2_back_length_total ?>" readonly="readonly"></td>
                                ...
                                <td><input type="text" class="form-control quilt-and-suit-costing" id="body_material_3_back_length_total" name="body_material_3_back_length_total" value="<?php echo $body_material_3_back_length_total ?>" readonly="readonly"></td>
                            </tr>
                            <tr>
                                <td>Width</td>
                                ...
                                <td><input type="text" class="form-control quilt-and-suit-costing" id="body_material_1_back_width_total" name="body_material_1_back_width_total" value="<?php echo $body_material_1_back_width_total ?>" readonly="readonly"></td>
                                ...
                                <td><input type="text" class="form-control quilt-and-suit-costing" id="body_material_2_back_width_total" name="body_material_2_back_width_total" value="<?php echo $body_material_2_back_width_total ?>" readonly="readonly"></td>
                                ...
                                <td><input type="text" class="form-control quilt-and-suit-costing" id="body_material_3_back_width_total" name="body_material_3_back_width_total" value="<?php echo $body_material_3_back_width_total ?>" readonly="readonly"></td>
                            </tr>
                            <tr>
                                <th rowspan="2">Top</th>
                                <td>Length</td>
                                ...
                                <td><input type="text" class="form-control quilt-and-suit-costing" id="body_material_1_top_length_total" name="body_material_1_top_length_total" value="<?php echo $body_material_1_top_length_total ?>" readonly="readonly"></td>
                                ...
                                <td><input type="text" class="form-control quilt-and-suit-costing" id="body_material_2_top_length_total" name="body_material_2_top_length_total" value="<?php echo $body_material_2_top_length_total ?>" readonly="readonly"></td>
                                ...
                                <td><input type="text" class="form-control quilt-and-suit-costing" id="body_material_3_top_length_total" name="body_material_3_top_length_total" value="<?php echo $body_material_3_top_length_total ?>" readonly="readonly"></td>
                            </tr>
                            <tr>
                                <td>Width</td>
                                ...
                                <td><input type="text" class="form-control quilt-and-suit-costing" id="body_material_1_top_width_total" name="body_material_1_top_width_total" value="<?php echo $body_material_1_top_width_total ?>" readonly="readonly"></td>
                                ...
                                <td><input type="text" class="form-control quilt-and-suit-costing" id="body_material_2_top_width_total" name="body_material_2_top_width_total" value="<?php echo $body_material_2_top_width_total ?>" readonly="readonly"></td>
                                ...
                                <td><input type="text" class="form-control quilt-and-suit-costing" id="body_material_3_top_width_total" name="body_material_3_top_width_total" value="<?php echo $body_material_3_top_width_total ?>" readonly="readonly"></td>
                            </tr>
                            <tr>
                                ...
                                <td><input type="text" class="form-control quilt-and-suit-costing" id="body_material_1_bottom_length_total" name="body_material_1_bottom_length_total" value="<?php echo $body_material_1_bottom_length_total ?>" readonly="readonly"></td>
                                ...
                                <td><input type="text" class="form-control quilt-and-suit-costing" id="body_material_2_bottom_length_total" name="body_material_2_bottom_length_total" value="<?php echo $body_material_2_bottom_length_total ?>" readonly="readonly"></td>
                                ...
                                <td><input type="text" class="form-control quilt-and-suit-costing" id="body_material_3_bottom_length_total" name="body_material_3_bottom_length_total" value="<?php echo $body_material_3_bottom_length_total ?>" readonly="readonly"></td>
                            </tr>
                            <tr>
                                <td>Width</td>
                                ...
                                <td><input type="text" class="form-control quilt-and-suit-costing" id="body_material_1_bottom_width_total" name="body_material_1_bottom_width_total" value="<?php echo $body_material_1_bottom_width_total ?>" readonly="readonly"></td>
                                ...
                                <td><input type="text" class="form-control quilt-and-suit-costing" id="body_material_2_bottom_width_total" name="body_material_2_bottom_width_total" value="<?php echo $body_material_2_bottom_width_total ?>" readonly="readonly"></td>
                                ...
                                <td><input type="text" class="form-control quilt-and-suit-costing" id="body_material_3_bottom_width_total" name="body_material_3_bottom_width_total" value="<?php echo $body_material_3_bottom_width_total ?>" readonly="readonly"></td>
                            </tr>
                            <tr>
                                ...
                                <td><input type="text" class="form-control quilt-and-suit-costing" id="body_material_1_left_length_total" name="body_material_1_left_length_total" value="<?php echo $body_material_1_left_length_total ?>" readonly="readonly"></td>
                                ...
                                <td><input type="text" class="form-control quilt-and-suit-costing" id="body_material_2_left_length_total" name="body_material_2_left_length_total" value="<?php echo $body_material_2_left_length_total ?>" readonly="readonly"></td>
                                ...
                                <td><input type="text" class="form-control quilt-and-suit-costing" id="body_material_3_left_length_total" name="body_material_3_left_length_total" value="<?php echo $body_material_3_left_length_total ?>" readonly="readonly"></td>
                            </tr>
                            <tr>
                                <td>Width</td>
                                ...
                                <td><input type="text" class="form-control quilt-and-suit-costing" id="body_material_1_left_width_total" name="body_material_1_left_width_total" value="<?php echo $body_material_1_left_width_total ?>" readonly="readonly"></td>
                                ...
                                <td><input type="text" class="form-control quilt-and-suit-costing" id="body_material_2_left_width_total" name="body_material_2_left_width_total" value="<?php echo $body_material_2_left_width_total ?>" readonly="readonly"></td>
                                ...
                                <td><input type="text" class="form-control quilt-and-suit-costing" id="body_material_3_left_width_total" name="body_material_3_left_width_total" value="<?php echo $body_material_3_left_width_total ?>" readonly="readonly"></td>
                            </tr>
                            <tr>
                                <th rowspan="2">Right</th>
                                <td>Length</td>
                                <td><input type="text" class="form-control quilt-and-suit-costing" id="body_material_1_right_length" name="body_material_1_right_length" value="<?php echo $body_material_1_right_length ?>"></td>
                                ...
                                <td><input type="text" class="form-control quilt-and-suit-costing" id="body_material_1_right_length_total" name="body_material_1_right_length_total" value="<?php echo $body_material_1_right_length_total ?>" readonly="readonly"></td>
                                ...
                                <td><input type="text" class="form-control quilt-and-suit-costing" id="body_material_2_right_length_total" name="body_material_2_right_length_total" value="<?php echo $body_material_2_right_length_total ?>" readonly="readonly"></td>
                                ...
                                <td><input type="text" class="form-control quilt-and-suit-costing" id="body_material_3_right_length_total" name="body_material_3_right_length_total" value="<?php echo $body_material_3_right_length_total ?>" readonly="readonly"></td>
                            </tr>
                            <tr>
                                <td>Width</td>
                                ...
                                <td><input type="text" class="form-control quilt-and-suit-costing" id="body_material_1_right_width_total" name="body_material_1_right_width_total" value="<?php echo $body_material_1_right_width_total ?>" readonly="readonly"></td>
                                ...
                                <td><input type="text" class="form-control quilt-and-suit-costing" id="body_material_2_right_width_total" name="body_material_2_right_width_total" value="<?php echo $body_material_2_right_width_total ?>" readonly="readonly"></td>
                                ...
                                <td><input type="text" class="form-control quilt-and-suit-costing" id="body_material_3_right_width_total" name="body_material_3_right_width_total" value="<?php echo $body_material_3_right_width_total ?>" readonly="readonly"></td>
                            </tr>
                            <tr>
                                ...
                                <td><input type="text" class="form-control quilt-and-suit-costing" id="body_material_1_handle_length_total" name="body_material_1_handle_length_total" value="<?php echo $body_material_1_handle_length_total ?>" readonly="readonly"></td>
                                ...
                                <td><input type="text" class="form-control quilt-and-suit-costing" id="body_material_2_handle_length_total" name="body_material_2_handle_length_total" value="<?php echo $body_material_2_handle_length_total ?>" readonly="readonly"></td>
                                ...
                                <td><input type="text" class="form-control quilt-and-suit-costing" id="body_material_3_handle_length_total" name="body_material_3_handle_length_total" value="<?php echo $body_material_3_handle_length_total ?>" readonly="readonly"></td>
                            </tr>
                            <tr>
                                <td>Width</td>
                                ...
                                <td><input type="text" class="form-control quilt-and-suit-costing" id="body_material_1_handle_width_total" name="body_material_1_handle_width_total" value="<?php echo $body_material_1_handle_width_total ?>"  readonly="readonly"></td>
                                ...
                                <td><input type="text" class="form-control quilt-and-suit-costing" id="body_material_2_handle_width_total" name="body_material_2_handle_width_total" value="<?php echo $body_material_2_handle_width_total ?>"  readonly="readonly"></td>
                                ...
                                <td><input type="text" class="form-control quilt-and-suit-costing" id="body_material_3_handle_width_total" name="body_material_3_handle_width_total" value="<?php echo $body_material_3_handle_width_total ?>"  readonly="readonly"></td>
                            </tr>
                            <tr>
                                ...
                                <td><input type="text" class="form-control quilt-and-suit-costing" id="body_material_1_pocket_length_total" name="body_material_1_pocket_length_total" value="<?php echo $body_material_1_pocket_length_total ?>" readonly="readonly"></td>
                                ...
                                <td><input type="text" class="form-control quilt-and-suit-costing" id="body_material_2_pocket_length_total" name="body_material_2_pocket_length_total" value="<?php echo $body_material_2_pocket_length_total ?>" readonly="readonly"></td>
                                ...
                                <td><input type="text" class="form-control quilt-and-suit-costing" id="body_material_3_pocket_length_total" name="body_material_3_pocket_length_total" value="<?php echo $body_material_3_pocket_length_total ?>" readonly="readonly"></td>
                            </tr>
                            <tr>
                                <td>Width</td>
                                ...
                                <td><input type="text" class="form-control quilt-and-suit-costing" id="body_material_1_pocket_width_total" name="body_material_1_pocket_width_total" value="<?php echo $body_material_1_pocket_width_total ?>" readonly="readonly"></td>
                                ...
                                <td><input type="text" class="form-control quilt-and-suit-costing" id="body_material_2_pocket_width_total" name="body_material_2_pocket_width_total" value="<?php echo $body_material_2_pocket_width_total ?>" readonly="readonly"></td>
                                ...
                                <td><input type="text" class="form-control quilt-and-suit-costing" id="body_material_3_pocket_width_total" name="body_material_3_pocket_width_total" value="<?php echo $body_material_3_pocket_width_total ?>" readonly="readonly"></td>
                            </tr>
                            <tr>
                                ...
                                <td><input type="text" class="form-control quilt-and-suit-costing" id="body_material_1_piping_length_total" name="body_material_1_piping_length_total" value="<?php echo $body_material_1_piping_length_total ?>" readonly="readonly"></td>
                                ...
                                <td><input type="text" class="form-control quilt-and-suit-costing" id="body_material_2_piping_length_total" name="body_material_2_piping_length_total" value="<?php echo $body_material_2_piping_length_total ?>" readonly="readonly"></td>
                                ...
                                <td><input type="text" class="form-control quilt-and-suit-costing" id="body_material_3_piping_length_total" name="body_material_3_piping_length_total" value="<?php echo $body_material_3_piping_length_total ?>" readonly="readonly"></td>
                            </tr>
                            <tr>
                                <td>Width</td>
                                ...
                                <td><input type="text" class="form-control quilt-and-suit-costing" id="body_material_3_piping_width_total" name="body_material_3_piping_width_total" value="<?php echo $body_material_3_piping_width_total ?>"readonly="readonly"></td>
                            </tr>
