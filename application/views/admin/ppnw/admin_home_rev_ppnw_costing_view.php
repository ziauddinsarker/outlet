                    ...
                    <div class="" >
                        <div class="col-md-5" >
                            ...
                            <div class="form-group" >
                                ...
                                <input type = "text" class="form-control" id = "order_colour" name = "order_colour" value = "<?php echo $s_rev->tbl_order_color ?>" >
                            </div >
                            <br >

                            <div class="form-group" >
                                <label for="order_usd" class="small-label" > USD:</label >
                                <input type = "text" class="form-control" id = "order_usd" name = "order_usd" value = "<?php echo $s_rev->tbl_order_usd ?>" required >
                            </div >


                            <div class="form-group" >
                                <label for="order_wastage" class="small-label" > Wastage:</label >
                                <input type = "text" class="form-control" id = "order_wastage" name = "order_wastage" value = "<?php echo $s_rev->tbl_order_wastage ?>" required >
                            </div >
                            ...
                            <div class="form-group" >
                                ...
                                <input type = "text" class="form-control" id = "order_margin" name = "order_margin" value = "<?php echo $s_rev->tbl_order_margin ?>" required >
                            </div >
                        ...
                        <div class="col-md-6" >
                            <div class="form-group" >
                                ...
                                <input type = "text" class="form-control" id = "order_quantity" name = "order_quantity" value = "<?php echo $s_rev->tbl_order_quantity ?>" required >
                            </div >

                            <div class="form-group" >
                                <label for="order_transport" class="small-label" > Transport:</label >
                                <input type = "text" class="form-control" id = "order_transport" name = "order_transport" value = "<?php echo $s_rev->tbl_order_transport ?>" > Tk / Truck
                            </div >
                            <br >

                            <div class="form-group" >
                                <label for="order_bank_document" > Bank & Document Charge:</label >
                                <input type = "text" class="form-control" id = "order_bank_document"  name = "order_bank_document" value = "<?php echo $s_rev->tbl_order_bank_doc_charge ?>" > Tk / Shipment
                            </div >
                            <br >
                    ...
                    <div class="part3" >
                        ...
                        <div class="row" >
                            <div class="col-md-3" >
                                <div class="form-group" >
                                    ...
                                    <input type = "text" class="form-control" id = "order_body_h" name = "order_body_h" value = "<?php echo $s_rev->tbl_dimension_body_height ?>" >
                                </div >
                            </div >
                            ...
                            <div class="col-md-4" >
                                <div class="form-group" >
                                    ...
                                    <input type = "text" class="form-control" id = "order_body_h_allowance" name = "order_body_h_allowance" value = "<?php echo $s_rev->tbl_dimension_body_height_allowance ?>" >
                                </div >
                            </div >
                            ...
                            <div class="col-md-4" >
                                <div class="form-group" >
                                    ...
                                    <input type = "text" class="form-control" id = "order_body_h_total" name = "order_body_h_total" value = "<?php echo $s_rev->tbl_dimension_body_height_total ?>" disabled >
                                </div >
                            </div >
                        </div >
                        ...
                        <div class="row" >
                            <div class="col-md-3" >
                                <div class="form-group" >
                                    ...
                                    <input type = "text" class="form-control" id = "order_body_w" name = "order_body_w" value = "<?php echo $s_rev->tbl_dimension_body_width ?>" >
                                </div >
                            </div >
                            ...
                            <div class="col-md-4" >
                                <div class="form-group" >
                                    <label for="order_body" > Allowance:</label >
                                    <input type = "text" class="form-control" id = "order_body_w_allowance" name = "order_body_w_allowance" value = "<?php echo $s_rev->tbl_dimension_body_width_allowance ?>" >
                                </div >
                            </div >
                            ...
                            <div class="col-md-4" >
                                <div class="form-group" >
                                    <label for="order_body" > Total:</label >
                                    <input type = "text" class="form-control" id = "order_body_w_total" name = "order_body_w_total"  value = "<?php echo $s_rev->tbl_dimension_body_width_total ?>" disabled >
                                </div >
                            </div >
                        </div >
                        ...
                        <div class="row" >
                            <div class="col-md-3" >
                                <div class="form-group" >
                                    ...
                                    <input type = "text" class="form-control" id = "order_body_panel" name = "order_body_panel" value = "<?php echo $s_rev->tbl_dimension_body_panel ?>" >
                                </div >
                            </div >
                            ...
                            <div class="col-md-4" >
                                <div class="form-group" >
                                    <label for="order_body" > Allowance:</label >
                                    <input type = "text" class="form-control" id = "order_body_panel_allowance" name = "order_body_panel_allowance" value = "<?php echo $s_rev->tbl_dimension_body_panel_allowance ?>" >
                                </div >
                            </div >
                            ...
                            <div class="col-md-4" >
                                <div class="form-group" >
                                    <label for="order_body" > Total:</label >
                                    <input type = "text" class="form-control" id = "order_body_panel_total" name = "order_body_panel_total" value = "<?php echo $s_rev->tbl_dimension_body_panel_total ?>" disabled >
                                </div >
                            </div >
                        </div >
                        ...
                        <div class="row" >
                            <div class="col-md-3" >
                                <div class="form-group" >
                                    ...
                                    <input type = "text" class="form-control" id = "order_handle_l" name = "order_handle_l" value = "<?php echo $s_rev->tbl_dimension_handle_length ?>" >
                                </div >
                            </div >
                            ...
                            <div class="col-md-4" >
                                <div class="form-group" >
                                    <label for="order_body" > Allowance:</label >
                                    <input type = "text" class="form-control" id = "order_handle_l_allowance" name = "order_handle_l_allowance" value = "<?php echo $s_rev->tbl_dimension_handle_length_allowance ?>" >
                                </div >
                            </div >
                            ...
                            <div class="col-md-4" >
                                <div class="form-group" >
                                    <label for="order_body" > Total:</label >
                                    <input type = "text" class="form-control" id = "order_handle_l_total" name = "order_handle_l_total" value = "<?php echo $s_rev->tbl_dimension_handle_length_total ?>" disabled >
                                </div >
                            </div >
                        </div >
                        ...
                        <div class="row" >
                            <div class="col-md-3" >
                                <div class="form-group" >
                                    ...
                                    <input type = "text" class="form-control" id = "order_handle_w" name = "order_handle_w" value = "<?php echo $s_rev->tbl_dimension_handle_width ?>" >
                                </div >
                            </div >
                            ...
                            <div class="col-md-4" >
                                <div class="form-group" >
                                    <label for="order_body" > Allowance:</label >
                                    <input type = "text" class="form-control" id = "order_handle_w_allowance" name = "order_handle_w_allowance" value = "<?php echo $s_rev->tbl_dimension_handle_width_allowance ?>" >
                                </div >
                            </div >
                            ...
                            <div class="col-md-4" >
                                <div class="form-group" >
                                    <label for="order_body" > Total:</label >
                                    <input type = "text" class="form-control" id = "order_handle_w_total" name = "order_handle_w_total" value = "<?php echo $s_rev->tbl_dimension_handle_width_total ?>" disabled >
                                </div >
                            </div >
                        </div >
                        ...
                        <div class="row" >
                            <div class="col-md-3" >
                                <div class="form-group" >
                                    <label for="order_body" > L:</label >
                                    <input type = "text" class="form-control" id = "order_pocket_l" name = "order_pocket_l" value = "<?php echo $s_rev->tbl_dimension_pocket_length ?>" >
                                </div >
                            </div >
                            ...
                            <div class="col-md-4" >
                                <div class="form-group" >
                                    <label for="order_body" > Allowance:</label >
                                    <input type = "text" class="form-control" id = "order_pocket_l_allowance" name = "order_pocket_l_allowance" value = "<?php echo $s_rev->tbl_dimension_pocket_length_allowance ?>" >
                                </div >
                            </div >
                            ...
                            <div class="col-md-4" >
                                <div class="form-group" >
                                    <label for="order_body" > Total:</label >
                                    <input type = "text" class="form-control" id = "order_pocket_l_total" name = "order_pocket_l_total" value = "<?php echo $s_rev->tbl_dimension_pocket_length_total ?>" disabled >
                                </div >
                            </div >
                        </div >
                        ...
                        <div class="row" >
                            <div class="col-md-3" >
                                <div class="form-group" >
                                    <label for="order_body" > W:</label >
                                    <input type = "text" class="form-control" id = "order_pocket_w" name = "order_pocket_w" value = "<?php echo $s_rev->tbl_dimension_pocket_width ?>" >
                                </div >
                            </div >
                            ...
                            <div class="col-md-4" >
                                <div class="form-group" >
                                    <label for="order_body" > Allowance:</label >
                                    <input type = "text" class="form-control" id = "order_pocket_w_allowance" name = "order_pocket_w_allowance"  value = "<?php echo $s_rev->tbl_dimension_pocket_width_allowance ?>" >
                                </div >
                            </div >
                            ...
                            <div class="col-md-4" >
                                <div class="form-group" >
                                    <label for="order_body" > Total:</label >
                                    <input type = "text" class="form-control" id = "order_pocket_w_total" name = "order_pocket_w_total"  value = "<?php echo $s_rev->tbl_dimension_pocket_width_total ?>"  disabled >
                                </div >
                            </div >
                        </div >
                        ...
                        <div class="row" >
                            <div class="col-md-3" >
                                <div class="form-group" >
                                    <label for="order_body" > L:</label >
                                    <input type = "text" class="form-control" id = "order_extra_1_l" name = "order_extra_1_l" value = "<?php echo $s_rev->tbl_dimension_extra_1_length ?>" >
                                </div >
                            </div >
                            ...
                            <div class="col-md-4" >
                                <div class="form-group" >
                                    <label for="order_body" > Allowance:</label >
                                    <input type = "text" class="form-control" id = "order_extra_1_l_allowance" name = "order_extra_1_l_allowance" value = "<?php echo $s_rev->tbl_dimension_extra_1_length_allowance ?>" >
                                </div >
                            </div >
                            ...
                            <div class="col-md-4" >
                                <div class="form-group" >
                                    <label for="order_body" > Total:</label >
                                    <input type = "text" class="form-control" id = "order_extra_1_l_total" name = "order_extra_1_l_total" value = "<?php echo $s_rev->tbl_dimension_extra_1_length_total ?>" disabled >
                                </div >
                            </div >
                        </div >
                        ...
                        <div class="row" >
                            <div class="col-md-3" >
                                <div class="form-group" >
                                    <label for="order_body" > W:</label >
                                    <input type = "text" class="form-control" id = "order_extra_1_w" name = "order_extra_1_w" value = "<?php echo $s_rev->tbl_dimension_extra_1_width ?>" >
                                </div >
                            </div >
                            ...
                            <div class="col-md-4" >
                                <div class="form-group" >
                                    <label for="order_body" > Allowance:</label >
                                    <input type = "text" class="form-control" id = "order_extra_1_w_allowance" name = "order_extra_1_w_allowance" value = "<?php echo $s_rev->tbl_dimension_extra_1_width_allowance ?>" >
                                </div >
                            </div >
                            ...
                            <div class="col-md-4" >
                                <div class="form-group" >
                                    <label for="order_body" > Total:</label >
                                    <input type = "text" class="form-control" id = "order_extra_1_w_total" name = "order_extra_1_w_total" value = "<?php echo $s_rev->tbl_dimension_extra_1_width_total ?>" disabled >
                                </div >
                            </div >
                        </div >
                        ...
                        <div class="row" >
                            <div class="col-md-3" >
                                <div class="form-group" >
                                    <label for="order_body" > L:</label >
                                    <input type = "text" class="form-control" id = "order_extra_2_l" name = "order_extra_2_l" value = "<?php echo $s_rev->tbl_dimension_extra_2_length ?>" >
                                </div >
                            </div >
                            ...
                            <div class="col-md-4" >
                                <div class="form-group" >
                                    <label for="order_body" > Allowance:</label >
                                    <input type = "text" class="form-control" id = "order_extra_2_l_allowance" name = "order_extra_2_l_allowance" value = "<?php echo $s_rev->tbl_dimension_extra_2_length_allowance ?>" >
                                </div >
                            </div >
                            ...
                            <div class="col-md-4" >
                                <div class="form-group" >
                                    <label for="order_body" > Total:</label >
                                    <input type = "text" class="form-control" id = "order_extra_2_l_total" name = "order_extra_2_l_total" value = "<?php echo $s_rev->tbl_dimension_extra_2_length_total ?>" disabled >
                                </div >
                            </div >
                        </div >
                        ...
                        <div class="row" >
                            <div class="col-md-3" >
                                <div class="form-group" >
                                    <label for="order_body" > W:</label >
                                    <input type = "text" class="form-control" id = "order_extra_2_w" name = "order_extra_2_w" value = "<?php echo $s_rev->tbl_dimension_extra_2_width ?>" >
                                </div >
                            </div >
                            ...
                            <div class="col-md-4" >
                                <div class="form-group" >
                                    <label for="order_body" > Allowance:</label >
                                    <input type = "text" class="form-control" id = "order_extra_2_w_allowance" name = "order_extra_2_w_allowance" value = "<?php echo $s_rev->tbl_dimension_extra_2_width_allowance ?>" >
                                </div >
                            </div >
                            ...
                            <div class="col-md-4" >
                                <div class="form-group" >
                                    <label for="order_body" > Total:</label >
                                    <input type = "text" class="form-control" id = "order_extra_2_w_total" name = "order_extra_2_w_total" value = "<?php echo $s_rev->tbl_dimension_extra_2_width_total ?>" disabled >
                                </div >
                            </div >
                        </div >
                        ...
                        <div class="row" >
                            <div class="col-md-3" >
                                <div class="form-group" >
                                    <label for="order_body" > L:</label >
                                    <input type = "text" class="form-control" id = "order_extra_3_l" name = "order_extra_3_l" value = "<?php echo $s_rev->tbl_dimension_extra_3_length ?>" >
                                </div >
                            </div >
                            ...
                            <div class="col-md-4" >
                                <div class="form-group" >
                                    <label for="order_body" > Allowance:</label >
                                    <input type = "text" class="form-control" id = "order_extra_3_l_allowance" name = "order_extra_3_l_allowance" value = "<?php echo $s_rev->tbl_dimension_extra_3_length_allowance ?>" >
                                </div >
                            </div >
                            ...
                            <div class="col-md-4" >
                                <div class="form-group" >
                                    <label for="order_body" > Total:</label >
                                    <input type = "text" class="form-control" id = "order_extra_3_l_total" name = "order_extra_3_l_total" value = "<?php echo $s_rev->tbl_dimension_extra_3_length_total ?>" disabled >
                                </div >
                            </div >
                        </div >
                        ...
                        <div class="row" >
                            <div class="col-md-3" >
                                <div class="form-group" >
                                    <label for="order_body" > W:</label >
                                    <input type = "text" class="form-control" id = "order_extra_3_w" name = "order_extra_3_w" value = "<?php echo $s_rev->tbl_dimension_extra_3_width ?>" >
                                </div >
                            </div >
                            ...
                            <div class="col-md-4" >
                                <div class="form-group" >
                                    <label for="order_body" > Allowance:</label >
                                    <input type = "text" class="form-control" id = "order_extra_3_w_allowance" name = "order_extra_3_w_allowance" value = "<?php echo $s_rev->tbl_dimension_extra_3_width_allowance ?>" >
                                </div >
                            </div >
                            ...
                            <div class="col-md-4" >
                                <div class="form-group" >
                                    <label for="order_body" > Total:</label >
                                    <input type = "text" class="form-control" id = "order_extra_3_w_total" name = "order_extra_3_w_total"  value = "<?php echo $s_rev->tbl_dimension_extra_3_width_total ?>" disabled >
                                </div >
                            </div >
                        </div >
